...
abstract class Model
{
    ...
    {
        if (!empty($data)) {
            //get_object_vars - исследует объект переданный ей и возвращает список его определенных свойств
...
//            'App\Models\Article'
            //если хотим использовать специальную константу с именем класса
            static::class
        );
        return $data;
    }
